    ...
    public void listByCategory(String str) {
        switch (str.toLowerCase(Locale.ROOT)) {
            case "dairy":
                ...
                for (Item item : this.stock.get(Category.DAIRY)) {
                    System.out.println(item.getName());
                }
                break;
            case "frozen":
                System.out.println(Category.FROZEN.toString());
                for (Item item : this.stock.get(Category.FROZEN)) {
                    System.out.println(item.getName());
                }
                break;
            case "canned":
                System.out.println(Category.CANNED.toString());
                for (Item item : this.stock.get(Category.CANNED)) {
                    System.out.println(item.getName());
                }
                break;
            case "meat":
                System.out.println(Category.MEAT.toString());
                for (Item item : this.stock.get(Category.MEAT)) {
                    System.out.println(item.getName());
                }
                break;
            case "fruits":
                System.out.println(Category.FRUITS.toString());
                for (Item item : this.stock.get(Category.FRUITS)) {
                    System.out.println(item.getName());
                }
                break;
            case "vegetables":
                System.out.println(Category.VEGETABLES.toString());
                for (Item item : this.stock.get(Category.VEGETABLES)) {
                    System.out.println(item.getName());
                }
                break;
            default:
